...
-----
    ...
    python scripts/stage_07_run_api.py --host 127.0.0.1 --port 8000
    python scripts/stage_07_run_api.py --disable-auth
    python scripts/stage_07_run_api.py --model baseline
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Stage 07 — Run API server")
